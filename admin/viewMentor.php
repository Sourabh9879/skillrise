    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4 main-content">
                ...
                $sql = "SELECT user_id, user_name, user_email FROM user WHERE role = 'mentor'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <tr>
                            ...
                            <td><a href="delete_mentor.php?mentorId=' . $row['user_id'] . '" class="btn btn-danger btn-sm">Delete</a></td>
                        </tr>';
                    }
